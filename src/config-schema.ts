export const configSchema = {
  ...
  configPath: {
    ...
    default: "",
    description:
      "The configuration directory path. Leave it empty to use '~/.mume' as the config path. Please reload atom to take effect. Replaces '${projectDir}' with the current project directory of the engine.",
    order: 1,
  },
  singlePreview: {
