...
After version **0.8.6**, markdown-preview-enhanced will support [Code Chunks (beta)](./docs/code-chunk.md) that allows you to render code output into document.   
By using [Code Chunks (beta)](./docs/code-chunk.md), you can run **gnuplot**, **python**, **nodejs** and all other programs in your markdown file.   
