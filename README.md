...
Options `Use Github.com style` and `Use Github.com syntax theme` are removed from package settings. To use `Github.com` theme, install [octocat-syntax](https://atom.io/themes/octocat-syntax).  
