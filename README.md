...
You can now create **EBook** using this plugin! More information can be found [here](https://github.com/shd101wyy/markdown-preview-enhanced/tree/master/docs/ebook.md).
...
## Extra
* **EBook**  
	More information about how to create ebook can be found [here](https://github.com/shd101wyy/markdown-preview-enhanced/tree/master/docs/ebook.md).
* **Presentation Writer**  
