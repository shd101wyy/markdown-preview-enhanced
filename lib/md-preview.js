...
class MarkdownPreview {
  constructor(editor) {
    ...
    this.uri = 'markdown-preview-enhanced://' + editor.getPath() + ' preview'
  ...
  initEditorEvent() {
    ...
    this.disposables.add(
      this.editor.onDidDestroy(()=> {
        ...
        if (atom.config.get('markdown-preview-enhanced.closePreviewWhenClosingEditor') && this.previewEditor) {
