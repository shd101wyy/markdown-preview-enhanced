...
class MarkdownPreview {
  ...
  createPreviewElement() {
    ...
    if (!globalKatexStyle) {
      ...
      globalTextEditorStyle.innerHTML = getReplacedTextEditorStyles()
      globalTextEditorStyle.setAttribute('for', 'markdown-katex-preview')
      console.log(globalTextEditorStyle)
      document.getElementsByTagName('head')[0].appendChild(globalTextEditorStyle)
    }
  }
  ...
  initSettingsEvents() {
    ...
    // KaTeX?
    this.disposables.add(atom.config.observe('atom-markdown-katex.mathRenderingOption', (option)=> {
      setTimeout(()=> {
  ...
  renderMarkdown() {
      ...
      if (this.mathRenderingOption === 'MathJax' && MathJax) {
